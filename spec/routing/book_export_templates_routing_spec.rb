...
RSpec.describe BookExportTemplatesController, type: :routing do
  describe "routing" do
    ...
    it "routes to #edit" do
      expect(get: "/book_export_templates/1/edit").to route_to("book_export_templates#edit", id: "1")
    end
    ...
    it "routes to #update via PUT" do
      expect(put: "/book_export_templates/1").to route_to("book_export_templates#update", id: "1")
    end
    ...
    it "routes to #destroy" do
      expect(delete: "/book_export_templates/1").to route_to("book_export_templates#destroy", id: "1")
    end
  end
end
